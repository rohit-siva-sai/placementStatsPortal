...
const AluminiWork = () => {
  return (
    <div className="my-12 mx-16">
      ...
      <div className="relative mt-14 w-full h-[700px]  ">
        <div className="absolute  flex space-x-12 left-[50%] -translate-x-[50%] ">
          ...
          <div>
            <ProfileCard
            companyImage={"https://pngimg.com/uploads/amazon/amazon_PNG13.png"}
              role={"SD Engineer"}
              name={"Megha Shyam"}
              photo={
        ...
        <div className="absolute  flex space-x-[300px] top-[200px] left-[50%] -translate-x-[50%]  ">
          <div>
            <ProfileCard
              role={"System Analyst"}
              name={"Bharghavi"}
              companyImage={"https://download.logo.wine/logo/Cognizant/Cognizant-Logo.wine.png"}
              direction={"ml-auto"}
              photo={
