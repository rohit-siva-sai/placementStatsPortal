...
const PastEvent = () => {
  ...
  return (
    ...
    <div>
     {pastEvents.length >= 1 && <p className="recruit font-semibold text-blue-500  hover:scale-105 transition-all duration-300 hover:underline text-4xl cursor-pointer underline-offset-8 decoration-slate-500 text-center">
        Past Events
      </p>}
      {pastEvents.length < 1 ? (
        <div className="mt-12 font-semibold text-xl text-center text-gray-700">There are no Past events</div>
      ) : (
              ...
              <div className="border pb-4 rounded-lg shadow-lg cursor-pointer  shadow-blue-400 hover:scale-105 duration-500 transition-all">
                ...
                <p className="font-bold text-lg text-emerald-600">
                  ...
                  <div className="flex flex-col space-y-3 py-3">
                      <p className="font-semibold text-gray-800 text-lg">{item.heading}</p>
                      <p className="font-medium text-gray-600">{item.conductedBy}</p>
